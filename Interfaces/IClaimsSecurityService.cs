...
namespace SMD.Interfaces
{
    ...
    public interface IClaimsSecurityService
    {
        ...
        void AddCompanyIdClaimToIdentity(ClaimsIdentity identity, int CompanyId, string CompanyName, string CompanyLogo, string RoleName, string userName, string MobileNumber, string email, string RoleId, string CompanyCity);
    }
}
