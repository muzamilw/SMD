    ...
    public class UserPurchasedCouponRepository : BaseRepository<UserPurchasedCoupon>, IUserPurchasedCouponRepository
    {
        ...
        public IEnumerable<PurchasedCoupons> GetPurchasedCouponByUserId(string UserId)
        {
            ...
            var result = from c in db.Coupons
                         ...
                         select new PurchasedCoupons { CouponId = c.CouponId, CouponTitle = c.CouponTitle, CouponImage1 = c.couponImage1, Price = c.Price.Value, Savings = c.Savings.Value, CompanyId = c.CompanyId.Value, LogoUrl = c.LogoUrl, CouponPurchaseId = uc.CouponPurchaseId, LocationPhone = c.LocationPhone  };
