...
[assembly: System.Data.Mapping.EntityViewGenerationAttribute(typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySetsE861EC6BAF803A63C076C2A7B945F90DCE9551710EADF865C2B8CDFF480FF752))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    /// </Summary>
    public sealed class ViewsForBaseEntitySetsE861EC6BAF803A63C076C2A7B945F90DCE9551710EADF865C2B8CDFF480FF752 : System.Data.Mapping.EntityViewContainer
    {
        
        /// <Summary>
        /// The constructor stores the views for the extents and also the hash values generated based on the metadata and mapping closure and views.
        /// </Summary>
        public ViewsForBaseEntitySetsE861EC6BAF803A63C076C2A7B945F90DCE9551710EADF865C2B8CDFF480FF752()
        {
            this.EdmEntityContainerName = "BaseDbContext";
            this.StoreEntityContainerName = "SMDModelStoreContainer";
            this.HashOverMappingClosure = "703a8d67b231b9d1d6dc6477b35f6bc2039c1b755a96ed34dd874cedd3283afa";
            this.HashOverAllExtentViews = "9edc26feef327d1a607f224f7e989bd027a5412a644a3f7ffef80ce368017b02";
            this.ViewCount = 38;
        }
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(3880);
            ...
            viewString.Append(" T1.AspNetUsers_RegisteredViaReferral, T1.AspNetUsers_ReferringUserID, T1.AspNet");
            viewString.Append("Users_Age, T1.AspNetUsers_Gender)\r\n    FROM (\r\n        SELECT \r\n            T.Id");
            viewString.Append(" AS AspNetUsers_Id, \r\n            T.Email AS AspNetUsers_Email, \r\n            T.");
            viewString.Append("EmailConfirmed AS AspNetUsers_EmailConfirmed, \r\n            T.PasswordHash AS As");
            viewString.Append("pNetUsers_PasswordHash, \r\n            T.SecurityStamp AS AspNetUsers_SecuritySta");
            viewString.Append("mp, \r\n            T.PhoneNumber AS AspNetUsers_PhoneNumber, \r\n            T.Phon");
            viewString.Append("eNumberConfirmed AS AspNetUsers_PhoneNumberConfirmed, \r\n            T.TwoFactorE");
            viewString.Append("nabled AS AspNetUsers_TwoFactorEnabled, \r\n            T.LockoutEndDateUtc AS Asp");
            viewString.Append("NetUsers_LockoutEndDateUtc, \r\n            T.LockoutEnabled AS AspNetUsers_Lockou");
            viewString.Append("tEnabled, \r\n            T.AccessFailedCount AS AspNetUsers_AccessFailedCount, \r\n");
            viewString.Append("            T.UserName AS AspNetUsers_UserName, \r\n            T.FullName AS AspN");
            viewString.Append("etUsers_FullName, \r\n            T.AlternateEmail AS AspNetUsers_AlternateEmail, ");
            viewString.Append("\r\n            T.IsEmailVerified AS AspNetUsers_IsEmailVerified, \r\n            T.");
            viewString.Append("Status AS AspNetUsers_Status, \r\n            T.CreatedDateTime AS AspNetUsers_Cre");
            viewString.Append("atedDateTime, \r\n            T.ModifiedDateTime AS AspNetUsers_ModifiedDateTime, ");
            viewString.Append("\r\n            T.LastLoginTime AS AspNetUsers_LastLoginTime, \r\n            T.Phon");
            viewString.Append("e1 AS AspNetUsers_Phone1, \r\n            T.Phone2 AS AspNetUsers_Phone2, \r\n      ");
            viewString.Append("      T.Jobtitle AS AspNetUsers_Jobtitle, \r\n            T.ContactNotes AS AspNet");
            viewString.Append("Users_ContactNotes, \r\n            T.IsSubscribed AS AspNetUsers_IsSubscribed, \r\n");
            viewString.Append("            T.AppId AS AspNetUsers_AppID, \r\n            T.CompanyName AS AspNetU");
            viewString.Append("sers_CompanyName, \r\n            T.SalesEmail AS AspNetUsers_SalesEmail, \r\n      ");
            viewString.Append("      T.CompanyRepresentative AS AspNetUsers_CompanyRepresentative, \r\n          ");
            viewString.Append("  T.Address1 AS AspNetUsers_Address1, \r\n            T.Address2 AS AspNetUsers_Ad");
            viewString.Append("dress2, \r\n            T.CityId AS AspNetUsers_CityID, \r\n            T.CountryId ");
            viewString.Append("AS AspNetUsers_CountryID, \r\n            T.State AS AspNetUsers_State, \r\n        ");
            viewString.Append("    T.ZipCode AS AspNetUsers_ZipCode, \r\n            T.UserTimeZone AS AspNetUser");
            viewString.Append("s_UserTimeZone, \r\n            T.ReferralCode AS AspNetUsers_ReferralCode, \r\n    ");
            viewString.Append("        T.AfilliatianStatus AS AspNetUsers_AfilliatianStatus, \r\n            T.Ch");
            viewString.Append("argeBeeCustomerId AS AspNetUsers_ChargeBeeCustomerID, \r\n            T.ChargeBees");
            viewString.Append("ubscriptionId AS AspNetUsers_ChargeBeesubscriptionID, \r\n            T.Registered");
            viewString.Append("ViaReferral AS AspNetUsers_RegisteredViaReferral, \r\n            T.ReferringUserI");
            viewString.Append("d AS AspNetUsers_ReferringUserID, \r\n            T.Age AS AspNetUsers_Age, \r\n    ");
            viewString.Append("        T.Gender AS AspNetUsers_Gender, \r\n            True AS _from0\r\n        FR");
            viewString.Append("OM BaseDbContext.Users AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView20()
        {
            ...
            viewString.Append("tive AS User_CompanyRepresentative, \r\n            T.Address1 AS User_Address1, \r");
            viewString.Append("\n            T.Address2 AS User_Address2, \r\n            T.CityID AS User_CityId,");
            viewString.Append(" \r\n            T.CountryID AS User_CountryId, \r\n            T.State AS User_Stat");
            viewString.Append("e, \r\n            T.ZipCode AS User_ZipCode, \r\n            T.UserTimeZone AS User");
            ...
            viewString.Append("ID AS User_ChargeBeeCustomerId, \r\n            T.ChargeBeesubscriptionID AS User_");
            viewString.Append("ChargeBeesubscriptionId, \r\n            T.RegisteredViaReferral AS User_Registere");
            viewString.Append("dViaReferral, \r\n            T.ReferringUserID AS User_ReferringUserId, \r\n       ");
            viewString.Append("     T.Age AS User_Age, \r\n            T.Gender AS User_Gender, \r\n            Tru");
