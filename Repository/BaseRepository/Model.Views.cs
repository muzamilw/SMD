...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(9481);
            ...
            viewString.Append("_ShowBuyitBtn, T1.AdCampaign_IsPaymentCollected, T1.AdCampaign_PaymentDate, T1.A");
            viewString.Append("dCampaign_isAdDelivery)\r\n    FROM (\r\n        SELECT \r\n            T.CampaignId A");
            viewString.Append("S AdCampaign_CampaignID, \r\n            T.LanguageId AS AdCampaign_LanguageID, \r\n");
            viewString.Append("            T.UserId AS AdCampaign_UserID, \r\n            T.SmdCampaign AS AdCamp");
            viewString.Append("aign_SMDCampaign, \r\n            T.CampaignName AS AdCampaign_CampaignName, \r\n   ");
            viewString.Append("         T.CampaignDescription AS AdCampaign_CampaignDescription, \r\n            ");
            viewString.Append("T.Status AS AdCampaign_Status, \r\n            T.Archived AS AdCampaign_Archived, ");
            viewString.Append("\r\n            T.Approved AS AdCampaign_Approved, \r\n            T.ApprovedBy AS A");
            viewString.Append("dCampaign_ApprovedBy, \r\n            T.ApprovalDateTime AS AdCampaign_ApprovalDat");
            viewString.Append("eTime, \r\n            T.StartDateTime AS AdCampaign_StartDateTime, \r\n            ");
            viewString.Append("T.EndDateTime AS AdCampaign_EndDateTime, \r\n            T.MaxBudget AS AdCampaign");
            viewString.Append("_MaxBudget, \r\n            T.Type AS AdCampaign_Type, \r\n            T.ClickRate A");
            viewString.Append("S AdCampaign_ClickRate, \r\n            T.SmdCredits AS AdCampaign_SMDCredits, \r\n ");
            viewString.Append("           T.DisplayTitle AS AdCampaign_DisplayTitle, \r\n            T.Descriptio");
            viewString.Append("n AS AdCampaign_Description, \r\n            T.ImagePath AS AdCampaign_ImagePath, ");
            viewString.Append("\r\n            T.LandingPageVideoLink AS AdCampaign_LandingPageVideoLink, \r\n     ");
            viewString.Append("       T.VerifyQuestion AS AdCampaign_VerifyQuestion, \r\n            T.Answer1 AS");
            viewString.Append(" AdCampaign_Answer1, \r\n            T.Answer2 AS AdCampaign_Answer2, \r\n          ");
            viewString.Append("  T.Answer3 AS AdCampaign_Answer3, \r\n            T.CorrectAnswer AS AdCampaign_C");
            viewString.Append("orrectAnswer, \r\n            T.CreatedDateTime AS AdCampaign_CreatedDateTime, \r\n ");
            viewString.Append("           T.CreatedBy AS AdCampaign_CreatedBy, \r\n            T.ModifiedDateTime");
            viewString.Append(" AS AdCampaign_ModifiedDateTime, \r\n            T.ModifiedBy AS AdCampaign_Modifi");
            viewString.Append("edBy, \r\n            T.AgeRangeStart AS AdCampaign_AgeRangeStart, \r\n            T");
            viewString.Append(".AgeRangeEnd AS AdCampaign_AgeRangeEnd, \r\n            T.Gender AS AdCampaign_Gen");
            viewString.Append("der, \r\n            T.RejectedReason AS AdCampaign_RejectedReason, \r\n            ");
            viewString.Append("T.ProjectedReach AS AdCampaign_ProjectedReach, \r\n            T.ResultClicks AS A");
            viewString.Append("dCampaign_ResultClicks, \r\n            T.AmountSpent AS AdCampaign_AmountSpent, \r");
            viewString.Append("\n            T.RewardType AS AdCampaign_RewardType, \r\n            T.Voucher1Head");
            viewString.Append("ing AS AdCampaign_Voucher1Heading, \r\n            T.Voucher1Description AS AdCamp");
            viewString.Append("aign_Voucher1Description, \r\n            T.Voucher1Value AS AdCampaign_Voucher1Va");
            viewString.Append("lue, \r\n            T.Voucher2Heading AS AdCampaign_Voucher2Heading, \r\n          ");
            viewString.Append("  T.Voucher2Description AS AdCampaign_Voucher2Description, \r\n            T.Vouch");
            viewString.Append("er2Value AS AdCampaign_Voucher2Value, \r\n            T.Voucher1ImagePath AS AdCam");
            viewString.Append("paign_Voucher1ImagePath, \r\n            T.Voucher2ImagePath AS AdCampaign_Voucher");
            viewString.Append("2ImagePath, \r\n            T.VideoUrl AS AdCampaign_VideoUrl, \r\n            T.Buu");
            viewString.Append("yItLine1 AS AdCampaign_BuuyItLine1, \r\n            T.BuyItLine2 AS AdCampaign_Buy");
            viewString.Append("ItLine2, \r\n            T.BuyItLine3 AS AdCampaign_BuyItLine3, \r\n            T.Bu");
            viewString.Append("yItButtonLabel AS AdCampaign_BuyItButtonLabel, \r\n            T.BuyItImageUrl AS ");
            viewString.Append("AdCampaign_BuyItImageUrl, \r\n            T.CouponSwapValue AS AdCampaign_CouponSw");
            viewString.Append("apValue, \r\n            T.CouponActualValue AS AdCampaign_CouponActualValue, \r\n  ");
            viewString.Append("          T.CouponTakenCount AS AdCampaign_CouponTakenCount, \r\n            T.Cou");
            viewString.Append("ponQuantity AS AdCampaign_CouponQuantity, \r\n            T.CompanyId AS AdCampaig");
            viewString.Append("n_CompanyId, \r\n            T.priority AS AdCampaign_priority, \r\n            T.co");
            viewString.Append("uponSmdComission AS AdCampaign_couponSmdComission, \r\n            T.couponImage2 ");
            viewString.Append("AS AdCampaign_couponImage2, \r\n            T.CouponImage3 AS AdCampaign_CouponIma");
            viewString.Append("ge3, \r\n            T.CouponImage4 AS AdCampaign_CouponImage4, \r\n            T.Co");
            viewString.Append("uponExpiryLabel AS AdCampaign_CouponExpiryLabel, \r\n            T.CouponDiscountV");
            viewString.Append("alue AS AdCampaign_CouponDiscountValue, \r\n            T.CouponType AS AdCampaign");
            viewString.Append("_CouponType, \r\n            T.DeliveryDays AS AdCampaign_DeliveryDays, \r\n        ");
            viewString.Append("    T.IsUseFilter AS AdCampaign_IsUseFilter, \r\n            T.LogoUrl AS AdCampai");
            viewString.Append("gn_LogoUrl, \r\n            T.VoucherAdditionalInfo AS AdCampaign_VoucherAdditiona");
            viewString.Append("lInfo, \r\n            T.CouponId AS AdCampaign_CouponId, \r\n            T.IsShowVo");
            viewString.Append("ucherSetting AS AdCampaign_IsShowVoucherSetting, \r\n            T.VideoLink2 AS A");
            viewString.Append("dCampaign_VideoLink2, \r\n            T.VoucherHighlightLine1 AS AdCampaign_Vouche");
            viewString.Append("rHighlightLine1, \r\n            T.VoucherHighlightLine2 AS AdCampaign_VoucherHigh");
            viewString.Append("lightLine2, \r\n            T.VoucherHighlightLine3 AS AdCampaign_VoucherHighlight");
            viewString.Append("Line3, \r\n            T.VoucherHighlightLine4 AS AdCampaign_VoucherHighlightLine4");
            viewString.Append(", \r\n            T.VoucherHighlightLine5 AS AdCampaign_VoucherHighlightLine5, \r\n ");
            viewString.Append("           T.VoucherFinePrintLine1 AS AdCampaign_VoucherFinePrintLine1, \r\n      ");
            viewString.Append("      T.VoucherFinePrintLine2 AS AdCampaign_VoucherFinePrintLine2, \r\n           ");
            viewString.Append(" T.VoucherFinePrintLine3 AS AdCampaign_VoucherFinePrintLine3, \r\n            T.Vo");
            viewString.Append("ucherFinePrintLine4 AS AdCampaign_VoucherFinePrintLine4, \r\n            T.Voucher");
            viewString.Append("FinePrintLine5 AS AdCampaign_VoucherFinePrintLine5, \r\n            T.VoucherLocat");
            viewString.Append("ionLine1 AS AdCampaign_VoucherLocationLine1, \r\n            T.VoucherLocationLine");
            viewString.Append("2 AS AdCampaign_VoucherLocationLine2, \r\n            T.VoucherLocationLine3 AS Ad");
            viewString.Append("Campaign_VoucherLocationLine3, \r\n            T.VoucherLocationLine4 AS AdCampaig");
            viewString.Append("n_VoucherLocationLine4, \r\n            T.VoucherLocationLine5 AS AdCampaign_Vouch");
            viewString.Append("erLocationLine5, \r\n            T.VoucherHowToRedeemLine1 AS AdCampaign_VoucherHo");
            viewString.Append("wToRedeemLine1, \r\n            T.VoucherHowToRedeemLine2 AS AdCampaign_VoucherHow");
            viewString.Append("ToRedeemLine2, \r\n            T.VoucherHowToRedeemLine3 AS AdCampaign_VoucherHowT");
            viewString.Append("oRedeemLine3, \r\n            T.VoucherHowToRedeemLine4 AS AdCampaign_VoucherHowTo");
            viewString.Append("RedeemLine4, \r\n            T.VoucherHowToRedeemLine5 AS AdCampaign_VoucherHowToR");
            viewString.Append("edeemLine5, \r\n            T.VoucherRedemptionPhone AS AdCampaign_VoucherRedempti");
            viewString.Append("onPhone, \r\n            T.VoucherLocationLAT AS AdCampaign_VoucherLocationLAT, \r\n");
            viewString.Append("            T.VoucherLocationLON AS AdCampaign_VoucherLocationLON, \r\n           ");
            viewString.Append(" T.MaxDailyBudget AS AdCampaign_MaxDailyBudget, \r\n            T.SubmissionDateTi");
            viewString.Append("me AS AdCampaign_SubmissionDateTime, \r\n            T.ShowBuyitBtn AS AdCampaign_");
            viewString.Append("ShowBuyitBtn, \r\n            T.IsPaymentCollected AS AdCampaign_IsPaymentCollecte");
            viewString.Append("d, \r\n            T.PaymentDate AS AdCampaign_PaymentDate, \r\n            T.isAdDe");
            viewString.Append("livery AS AdCampaign_isAdDelivery, \r\n            True AS _from0\r\n        FROM Ba");
            viewString.Append("seDbContext.AdCampaigns AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(4607);
            ...
            viewString.Append("tionStatus, T1.Company_FreeAdsCounter)\r\n    FROM (\r\n        SELECT \r\n           ");
            viewString.Append(" T.CompanyId AS Company_CompanyId, \r\n            T.CompanyName AS Company_Compan");
            viewString.Append("yName, \r\n            T.ReplyEmail AS Company_ReplyEmail, \r\n            T.Tel1 AS");
            viewString.Append(" Company_Tel1, \r\n            T.Tel2 AS Company_Tel2, \r\n            T.AddressLine");
            viewString.Append("1 AS Company_AddressLine1, \r\n            T.AddressLine2 AS Company_AddressLine2,");
            viewString.Append(" \r\n            T.State AS Company_State, \r\n            T.CountryId AS Company_Co");
            viewString.Append("untryId, \r\n            T.ZipCode AS Company_ZipCode, \r\n            T.TimeZone AS");
            viewString.Append(" Company_TimeZone, \r\n            T.Logo AS Company_Logo, \r\n            T.StripeC");
            viewString.Append("ustomerId AS Company_StripeCustomerId, \r\n            T.RegisteredViaReferral AS ");
            viewString.Append("Company_RegisteredViaReferral, \r\n            T.ReferringCompanyID AS Company_Ref");
            viewString.Append("erringCompanyID, \r\n            T.PaypalCustomerId AS Company_PaypalCustomerId, \r");
            viewString.Append("\n            T.GoogleWalletCustomerId AS Company_GoogleWalletCustomerId, \r\n     ");
            viewString.Append("       T.PreferredPayoutAccount AS Company_PreferredPayoutAccount, \r\n           ");
            viewString.Append(" T.SalesEmail AS Company_SalesEmail, \r\n            T.ReferralCode AS Company_Ref");
            viewString.Append("erralCode, \r\n            T.AfilliatianStatus AS Company_AfilliatianStatus, \r\n   ");
            viewString.Append("         T.WebsiteLink AS Company_WebsiteLink, \r\n            T.CompanyType AS Co");
            viewString.Append("mpany_CompanyType, \r\n            T.BillingAddressLine1 AS Company_BillingAddress");
            viewString.Append("Line1, \r\n            T.BillingAddressLine2 AS Company_BillingAddressLine2, \r\n   ");
            viewString.Append("         T.BillingState AS Company_BillingState, \r\n            T.BillingCountryI");
            viewString.Append("d AS Company_BillingCountryId, \r\n            T.BillingZipCode AS Company_Billing");
            viewString.Append("ZipCode, \r\n            T.BillingPhone AS Company_BillingPhone, \r\n            T.B");
            viewString.Append("illingEmail AS Company_BillingEmail, \r\n            T.TwitterHandle AS Company_Tw");
            viewString.Append("itterHandle, \r\n            T.FacebookHandle AS Company_FacebookHandle, \r\n       ");
            viewString.Append("     T.InstagramHandle AS Company_InstagramHandle, \r\n            T.PinterestHand");
            viewString.Append("le AS Company_PinterestHandle, \r\n            T.VoucherSecretKey AS Company_Vouch");
            viewString.Append("erSecretKey, \r\n            T.City AS Company_City, \r\n            T.BillingCity A");
            viewString.Append("S Company_BillingCity, \r\n            T.AboutUsDescription AS Company_AboutUsDesc");
            viewString.Append("ription, \r\n            T.Status AS Company_Status, \r\n            T.PaymentMethod");
            viewString.Append("Status AS Company_PaymentMethodStatus, \r\n            T.LastPaymentMethodErrorDat");
            viewString.Append("e AS Company_LastPaymentMethodErrorDate, \r\n            T.LastPaymentMethodError ");
            viewString.Append("AS Company_LastPaymentMethodError, \r\n            T.CompanyRegNo AS Company_Compa");
            viewString.Append("nyRegNo, \r\n            T.TaxRegNo AS Company_TaxRegNo, \r\n            T.CreationD");
            viewString.Append("ateTime AS Company_CreationDateTime, \r\n            T.NoOfBranches AS Company_NoO");
            viewString.Append("fBranches, \r\n            T.BillingAddressName AS Company_BillingAddressName, \r\n ");
            viewString.Append("           T.IsDeleted AS Company_IsDeleted, \r\n            T.DeleteDate AS Compa");
            viewString.Append("ny_DeleteDate, \r\n            T.IsSpecialAccount AS Company_IsSpecialAccount, \r\n ");
            viewString.Append("           T.StripeSubscriptionId AS Company_StripeSubscriptionId, \r\n           ");
            viewString.Append(" T.StripeSubscriptionStatus AS Company_StripeSubscriptionStatus, \r\n            T");
            viewString.Append(".FreeAdsCounter AS Company_FreeAdsCounter, \r\n            True AS _from0\r\n       ");
            viewString.Append(" FROM BaseDbContext.Companies AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(7837);
            ...
            viewString.Append("rstDiscountType, T1.Coupon_DealEndingDiscountType, T1.Coupon_CashBackDeal, T1.Co");
            viewString.Append("upon_PinCode, T1.Coupon_CashBackDealCounter, T1.Coupon_IsAppliedDec)\r\n    FROM (");
            viewString.Append("\r\n        SELECT \r\n            T.CouponId AS Coupon_CouponId, \r\n            T.La");
            viewString.Append("nguageId AS Coupon_LanguageId, \r\n            T.UserId AS Coupon_UserId, \r\n      ");
            viewString.Append("      T.CouponTitle AS Coupon_CouponTitle, \r\n            T.SearchKeywords AS Cou");
            viewString.Append("pon_SearchKeywords, \r\n            T.Status AS Coupon_Status, \r\n            T.Arc");
            viewString.Append("hived AS Coupon_Archived, \r\n            T.Approved AS Coupon_Approved, \r\n       ");
            viewString.Append("     T.ApprovedBy AS Coupon_ApprovedBy, \r\n            T.ApprovalDateTime AS Coup");
            viewString.Append("on_ApprovalDateTime, \r\n            T.CreatedDateTime AS Coupon_CreatedDateTime, ");
            viewString.Append("\r\n            T.CreatedBy AS Coupon_CreatedBy, \r\n            T.ModifiedDateTime ");
            viewString.Append("AS Coupon_ModifiedDateTime, \r\n            T.ModifiedBy AS Coupon_ModifiedBy, \r\n ");
            viewString.Append("           T.RejectedReason AS Coupon_RejectedReason, \r\n            T.Rejectedda");
            viewString.Append("tetime AS Coupon_Rejecteddatetime, \r\n            T.RejectedBy AS Coupon_Rejected");
            viewString.Append("By, \r\n            T.CurrencyId AS Coupon_CurrencyId, \r\n            T.Price AS Co");
            viewString.Append("upon_Price, \r\n            T.Savings AS Coupon_Savings, \r\n            T.SwapCost ");
            viewString.Append("AS Coupon_SwapCost, \r\n            T.CouponViewCount AS Coupon_CouponViewCount, \r");
            viewString.Append("\n            T.CouponIssuedCount AS Coupon_CouponIssuedCount, \r\n            T.Co");
            viewString.Append("uponRedeemedCount AS Coupon_CouponRedeemedCount, \r\n            T.CouponQtyPerUse");
            viewString.Append("r AS Coupon_CouponQtyPerUser, \r\n            T.CouponListingMode AS Coupon_Coupon");
            viewString.Append("ListingMode, \r\n            T.CompanyId AS Coupon_CompanyId, \r\n            T.Coup");
            viewString.Append("onActiveMonth AS Coupon_CouponActiveMonth, \r\n            T.CouponActiveYear AS C");
            viewString.Append("oupon_CouponActiveYear, \r\n            T.CouponExpirydate AS Coupon_CouponExpiryd");
            viewString.Append("ate, \r\n            T.couponImage1 AS Coupon_couponImage1, \r\n            T.Coupon");
            viewString.Append("Image2 AS Coupon_CouponImage2, \r\n            T.CouponImage3 AS Coupon_CouponImag");
            viewString.Append("e3, \r\n            T.LogoUrl AS Coupon_LogoUrl, \r\n            T.HighlightLine1 AS");
            viewString.Append(" Coupon_HighlightLine1, \r\n            T.HighlightLine2 AS Coupon_HighlightLine2,");
            viewString.Append(" \r\n            T.HighlightLine3 AS Coupon_HighlightLine3, \r\n            T.Highli");
            viewString.Append("ghtLine4 AS Coupon_HighlightLine4, \r\n            T.HighlightLine5 AS Coupon_High");
            viewString.Append("lightLine5, \r\n            T.FinePrintLine1 AS Coupon_FinePrintLine1, \r\n         ");
            viewString.Append("   T.FinePrintLine2 AS Coupon_FinePrintLine2, \r\n            T.FinePrintLine3 AS ");
            viewString.Append("Coupon_FinePrintLine3, \r\n            T.FinePrintLine4 AS Coupon_FinePrintLine4, ");
            viewString.Append("\r\n            T.FinePrintLine5 AS Coupon_FinePrintLine5, \r\n            T.Locatio");
            viewString.Append("nBranchId AS Coupon_LocationBranchId, \r\n            T.LocationTitle AS Coupon_Lo");
            viewString.Append("cationTitle, \r\n            T.LocationLine1 AS Coupon_LocationLine1, \r\n          ");
            viewString.Append("  T.LocationLine2 AS Coupon_LocationLine2, \r\n            T.LocationCity AS Coupo");
            viewString.Append("n_LocationCity, \r\n            T.LocationState AS Coupon_LocationState, \r\n       ");
            viewString.Append("     T.LocationZipCode AS Coupon_LocationZipCode, \r\n            T.LocationLAT AS");
            viewString.Append(" Coupon_LocationLAT, \r\n            T.LocationLON AS Coupon_LocationLON, \r\n      ");
            viewString.Append("      T.LocationPhone AS Coupon_LocationPhone, \r\n            T.GeographyColumn A");
            viewString.Append("S Coupon_GeographyColumn, \r\n            T.HowToRedeemLine1 AS Coupon_HowToRedeem");
            viewString.Append("Line1, \r\n            T.HowToRedeemLine2 AS Coupon_HowToRedeemLine2, \r\n          ");
            viewString.Append("  T.HowToRedeemLine3 AS Coupon_HowToRedeemLine3, \r\n            T.HowToRedeemLine");
            viewString.Append("4 AS Coupon_HowToRedeemLine4, \r\n            T.HowToRedeemLine5 AS Coupon_HowToRe");
            viewString.Append("deemLine5, \r\n            T.SubmissionDateTime AS Coupon_SubmissionDateTime, \r\n  ");
            viewString.Append("          T.LocationCountryId AS Coupon_LocationCountryId, \r\n            T.Coupo");
            viewString.Append("nStartDate AS Coupon_CouponStartDate, \r\n            T.CouponEndDate AS Coupon_Co");
            viewString.Append("uponEndDate, \r\n            T.Priority AS Coupon_Priority, \r\n            T.ShowBu");
            viewString.Append("yitBtn AS Coupon_ShowBuyitBtn, \r\n            T.BuyitLandingPageUrl AS Coupon_Buy");
            viewString.Append("itLandingPageUrl, \r\n            T.BuyitBtnLabel AS Coupon_BuyitBtnLabel, \r\n     ");
            viewString.Append("       T.YoutubeLink AS Coupon_YoutubeLink, \r\n            T.CouponImage4 AS Coup");
            viewString.Append("on_CouponImage4, \r\n            T.CouponImage5 AS Coupon_CouponImage5, \r\n        ");
            viewString.Append("    T.CouponImage6 AS Coupon_CouponImage6, \r\n            T.IsPaymentCollected AS");
            viewString.Append(" Coupon_IsPaymentCollected, \r\n            T.PaymentDate AS Coupon_PaymentDate, \r");
            viewString.Append("\n            T.IsShowReviews AS Coupon_IsShowReviews, \r\n            T.IsShowAddr");
            viewString.Append("ess AS Coupon_IsShowAddress, \r\n            T.IsShowPhoneNo AS Coupon_IsShowPhone");
            viewString.Append("No, \r\n            T.IsShowMap AS Coupon_IsShowMap, \r\n            T.IsShowyouTube");
            viewString.Append(" AS Coupon_IsShowyouTube, \r\n            T.IsShowAboutUs AS Coupon_IsShowAboutUs,");
            viewString.Append(" \r\n            T.IsMarketingStories AS Coupon_IsMarketingStories, \r\n            ");
            viewString.Append("T.IsPerSaving3days AS Coupon_IsPerSaving3days, \r\n            T.IsPerSaving2days ");
            viewString.Append("AS Coupon_IsPerSaving2days, \r\n            T.IsPerSavingLastday AS Coupon_IsPerSa");
            viewString.Append("vingLastday, \r\n            T.IsDollarSaving3days AS Coupon_IsDollarSaving3days, ");
            viewString.Append("\r\n            T.IsDollarSaving2days AS Coupon_IsDollarSaving2days, \r\n           ");
            viewString.Append(" T.IsDollarSavingLastday AS Coupon_IsDollarSavingLastday, \r\n            T.isSave");
            viewString.Append("BtnLable AS Coupon_isSaveBtnLable, \r\n            T.DealFirstDiscountType AS Coup");
            viewString.Append("on_DealFirstDiscountType, \r\n            T.DealEndingDiscountType AS Coupon_DealE");
            viewString.Append("ndingDiscountType, \r\n            T.CashBackDeal AS Coupon_CashBackDeal, \r\n      ");
            viewString.Append("      T.PinCode AS Coupon_PinCode, \r\n            T.CashBackDealCounter AS Coupon");
            viewString.Append("_CashBackDealCounter, \r\n            T.IsAppliedDec AS Coupon_IsAppliedDec, \r\n   ");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(9488);
            ...
            viewString.Append("ShowBuyitBtn, T1.AdCampaign_IsPaymentCollected, T1.AdCampaign_PaymentDate, T1.Ad");
            viewString.Append("Campaign_isAdDelivery)\r\n    FROM (\r\n        SELECT \r\n            T.CampaignID AS");
            viewString.Append(" AdCampaign_CampaignId, \r\n            T.LanguageID AS AdCampaign_LanguageId, \r\n ");
            viewString.Append("           T.UserID AS AdCampaign_UserId, \r\n            T.SMDCampaign AS AdCampa");
            viewString.Append("ign_SmdCampaign, \r\n            T.CampaignName AS AdCampaign_CampaignName, \r\n    ");
            viewString.Append("        T.CampaignDescription AS AdCampaign_CampaignDescription, \r\n            T");
            viewString.Append(".Status AS AdCampaign_Status, \r\n            T.Archived AS AdCampaign_Archived, \r");
            viewString.Append("\n            T.Approved AS AdCampaign_Approved, \r\n            T.ApprovedBy AS Ad");
            viewString.Append("Campaign_ApprovedBy, \r\n            T.ApprovalDateTime AS AdCampaign_ApprovalDate");
            viewString.Append("Time, \r\n            T.StartDateTime AS AdCampaign_StartDateTime, \r\n            T");
            viewString.Append(".EndDateTime AS AdCampaign_EndDateTime, \r\n            T.MaxBudget AS AdCampaign_");
            viewString.Append("MaxBudget, \r\n            T.Type AS AdCampaign_Type, \r\n            T.ClickRate AS");
            viewString.Append(" AdCampaign_ClickRate, \r\n            T.SMDCredits AS AdCampaign_SmdCredits, \r\n  ");
            viewString.Append("          T.DisplayTitle AS AdCampaign_DisplayTitle, \r\n            T.Description");
            viewString.Append(" AS AdCampaign_Description, \r\n            T.ImagePath AS AdCampaign_ImagePath, \r");
            viewString.Append("\n            T.LandingPageVideoLink AS AdCampaign_LandingPageVideoLink, \r\n      ");
            viewString.Append("      T.VerifyQuestion AS AdCampaign_VerifyQuestion, \r\n            T.Answer1 AS ");
            viewString.Append("AdCampaign_Answer1, \r\n            T.Answer2 AS AdCampaign_Answer2, \r\n           ");
            viewString.Append(" T.Answer3 AS AdCampaign_Answer3, \r\n            T.CorrectAnswer AS AdCampaign_Co");
            viewString.Append("rrectAnswer, \r\n            T.CreatedDateTime AS AdCampaign_CreatedDateTime, \r\n  ");
            viewString.Append("          T.CreatedBy AS AdCampaign_CreatedBy, \r\n            T.ModifiedDateTime ");
            viewString.Append("AS AdCampaign_ModifiedDateTime, \r\n            T.ModifiedBy AS AdCampaign_Modifie");
            viewString.Append("dBy, \r\n            T.AgeRangeStart AS AdCampaign_AgeRangeStart, \r\n            T.");
            viewString.Append("AgeRangeEnd AS AdCampaign_AgeRangeEnd, \r\n            T.Gender AS AdCampaign_Gend");
            viewString.Append("er, \r\n            T.RejectedReason AS AdCampaign_RejectedReason, \r\n            T");
            viewString.Append(".ProjectedReach AS AdCampaign_ProjectedReach, \r\n            T.ResultClicks AS Ad");
            viewString.Append("Campaign_ResultClicks, \r\n            T.AmountSpent AS AdCampaign_AmountSpent, \r\n");
            viewString.Append("            T.RewardType AS AdCampaign_RewardType, \r\n            T.Voucher1Headi");
            viewString.Append("ng AS AdCampaign_Voucher1Heading, \r\n            T.Voucher1Description AS AdCampa");
            viewString.Append("ign_Voucher1Description, \r\n            T.Voucher1Value AS AdCampaign_Voucher1Val");
            viewString.Append("ue, \r\n            T.Voucher2Heading AS AdCampaign_Voucher2Heading, \r\n           ");
            viewString.Append(" T.Voucher2Description AS AdCampaign_Voucher2Description, \r\n            T.Vouche");
            viewString.Append("r2Value AS AdCampaign_Voucher2Value, \r\n            T.Voucher1ImagePath AS AdCamp");
            viewString.Append("aign_Voucher1ImagePath, \r\n            T.Voucher2ImagePath AS AdCampaign_Voucher2");
            viewString.Append("ImagePath, \r\n            T.VideoUrl AS AdCampaign_VideoUrl, \r\n            T.Buuy");
            viewString.Append("ItLine1 AS AdCampaign_BuuyItLine1, \r\n            T.BuyItLine2 AS AdCampaign_BuyI");
            viewString.Append("tLine2, \r\n            T.BuyItLine3 AS AdCampaign_BuyItLine3, \r\n            T.Buy");
            viewString.Append("ItButtonLabel AS AdCampaign_BuyItButtonLabel, \r\n            T.BuyItImageUrl AS A");
            viewString.Append("dCampaign_BuyItImageUrl, \r\n            T.CouponSwapValue AS AdCampaign_CouponSwa");
            viewString.Append("pValue, \r\n            T.CouponActualValue AS AdCampaign_CouponActualValue, \r\n   ");
            viewString.Append("         T.CouponTakenCount AS AdCampaign_CouponTakenCount, \r\n            T.Coup");
            viewString.Append("onQuantity AS AdCampaign_CouponQuantity, \r\n            T.CompanyId AS AdCampaign");
            viewString.Append("_CompanyId, \r\n            T.priority AS AdCampaign_priority, \r\n            T.cou");
            viewString.Append("ponSmdComission AS AdCampaign_couponSmdComission, \r\n            T.couponImage2 A");
            viewString.Append("S AdCampaign_couponImage2, \r\n            T.CouponImage3 AS AdCampaign_CouponImag");
            viewString.Append("e3, \r\n            T.CouponImage4 AS AdCampaign_CouponImage4, \r\n            T.Cou");
            viewString.Append("ponExpiryLabel AS AdCampaign_CouponExpiryLabel, \r\n            T.CouponDiscountVa");
            viewString.Append("lue AS AdCampaign_CouponDiscountValue, \r\n            T.CouponType AS AdCampaign_");
            viewString.Append("CouponType, \r\n            T.DeliveryDays AS AdCampaign_DeliveryDays, \r\n         ");
            viewString.Append("   T.IsUseFilter AS AdCampaign_IsUseFilter, \r\n            T.LogoUrl AS AdCampaig");
            viewString.Append("n_LogoUrl, \r\n            T.VoucherAdditionalInfo AS AdCampaign_VoucherAdditional");
            viewString.Append("Info, \r\n            T.CouponId AS AdCampaign_CouponId, \r\n            T.IsShowVou");
            viewString.Append("cherSetting AS AdCampaign_IsShowVoucherSetting, \r\n            T.VideoLink2 AS Ad");
            viewString.Append("Campaign_VideoLink2, \r\n            T.VoucherHighlightLine1 AS AdCampaign_Voucher");
            viewString.Append("HighlightLine1, \r\n            T.VoucherHighlightLine2 AS AdCampaign_VoucherHighl");
            viewString.Append("ightLine2, \r\n            T.VoucherHighlightLine3 AS AdCampaign_VoucherHighlightL");
            viewString.Append("ine3, \r\n            T.VoucherHighlightLine4 AS AdCampaign_VoucherHighlightLine4,");
            viewString.Append(" \r\n            T.VoucherHighlightLine5 AS AdCampaign_VoucherHighlightLine5, \r\n  ");
            viewString.Append("          T.VoucherFinePrintLine1 AS AdCampaign_VoucherFinePrintLine1, \r\n       ");
            viewString.Append("     T.VoucherFinePrintLine2 AS AdCampaign_VoucherFinePrintLine2, \r\n            ");
            viewString.Append("T.VoucherFinePrintLine3 AS AdCampaign_VoucherFinePrintLine3, \r\n            T.Vou");
            viewString.Append("cherFinePrintLine4 AS AdCampaign_VoucherFinePrintLine4, \r\n            T.VoucherF");
            viewString.Append("inePrintLine5 AS AdCampaign_VoucherFinePrintLine5, \r\n            T.VoucherLocati");
            viewString.Append("onLine1 AS AdCampaign_VoucherLocationLine1, \r\n            T.VoucherLocationLine2");
            viewString.Append(" AS AdCampaign_VoucherLocationLine2, \r\n            T.VoucherLocationLine3 AS AdC");
            viewString.Append("ampaign_VoucherLocationLine3, \r\n            T.VoucherLocationLine4 AS AdCampaign");
            viewString.Append("_VoucherLocationLine4, \r\n            T.VoucherLocationLine5 AS AdCampaign_Vouche");
            viewString.Append("rLocationLine5, \r\n            T.VoucherHowToRedeemLine1 AS AdCampaign_VoucherHow");
            viewString.Append("ToRedeemLine1, \r\n            T.VoucherHowToRedeemLine2 AS AdCampaign_VoucherHowT");
            viewString.Append("oRedeemLine2, \r\n            T.VoucherHowToRedeemLine3 AS AdCampaign_VoucherHowTo");
            viewString.Append("RedeemLine3, \r\n            T.VoucherHowToRedeemLine4 AS AdCampaign_VoucherHowToR");
            viewString.Append("edeemLine4, \r\n            T.VoucherHowToRedeemLine5 AS AdCampaign_VoucherHowToRe");
            viewString.Append("deemLine5, \r\n            T.VoucherRedemptionPhone AS AdCampaign_VoucherRedemptio");
            viewString.Append("nPhone, \r\n            T.VoucherLocationLAT AS AdCampaign_VoucherLocationLAT, \r\n ");
            viewString.Append("           T.VoucherLocationLON AS AdCampaign_VoucherLocationLON, \r\n            ");
            viewString.Append("T.MaxDailyBudget AS AdCampaign_MaxDailyBudget, \r\n            T.SubmissionDateTim");
            viewString.Append("e AS AdCampaign_SubmissionDateTime, \r\n            T.ShowBuyitBtn AS AdCampaign_S");
            viewString.Append("howBuyitBtn, \r\n            T.IsPaymentCollected AS AdCampaign_IsPaymentCollected");
            viewString.Append(", \r\n            T.PaymentDate AS AdCampaign_PaymentDate, \r\n            T.isAdDel");
            viewString.Append("ivery AS AdCampaign_isAdDelivery, \r\n            True AS _from0\r\n        FROM SMD");
            viewString.Append("ModelStoreContainer.AdCampaign AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(4614);
            ...
            viewString.Append(" T.StripeSubscriptionStatus AS Company_StripeSubscriptionStatus, \r\n            T");
            viewString.Append(".FreeAdsCounter AS Company_FreeAdsCounter, \r\n            True AS _from0\r\n       ");
            viewString.Append(" FROM SMDModelStoreContainer.Company AS T\r\n    ) AS T1");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(7844);
            ...
            viewString.Append("stDiscountType, T1.Coupon_DealEndingDiscountType, T1.Coupon_CashBackDeal, T1.Cou");
            viewString.Append("pon_PinCode, T1.Coupon_CashBackDealCounter, T1.Coupon_IsAppliedDec)\r\n    FROM (\r");
            viewString.Append("\n        SELECT \r\n            T.CouponId AS Coupon_CouponId, \r\n            T.Lan");
            viewString.Append("guageId AS Coupon_LanguageId, \r\n            T.UserId AS Coupon_UserId, \r\n       ");
            viewString.Append("     T.CouponTitle AS Coupon_CouponTitle, \r\n            T.SearchKeywords AS Coup");
            viewString.Append("on_SearchKeywords, \r\n            T.Status AS Coupon_Status, \r\n            T.Arch");
            viewString.Append("ived AS Coupon_Archived, \r\n            T.Approved AS Coupon_Approved, \r\n        ");
            viewString.Append("    T.ApprovedBy AS Coupon_ApprovedBy, \r\n            T.ApprovalDateTime AS Coupo");
            viewString.Append("n_ApprovalDateTime, \r\n            T.CreatedDateTime AS Coupon_CreatedDateTime, \r");
            viewString.Append("\n            T.CreatedBy AS Coupon_CreatedBy, \r\n            T.ModifiedDateTime A");
            viewString.Append("S Coupon_ModifiedDateTime, \r\n            T.ModifiedBy AS Coupon_ModifiedBy, \r\n  ");
            viewString.Append("          T.RejectedReason AS Coupon_RejectedReason, \r\n            T.Rejecteddat");
            viewString.Append("etime AS Coupon_Rejecteddatetime, \r\n            T.RejectedBy AS Coupon_RejectedB");
            viewString.Append("y, \r\n            T.CurrencyId AS Coupon_CurrencyId, \r\n            T.Price AS Cou");
            viewString.Append("pon_Price, \r\n            T.Savings AS Coupon_Savings, \r\n            T.SwapCost A");
            viewString.Append("S Coupon_SwapCost, \r\n            T.CouponViewCount AS Coupon_CouponViewCount, \r\n");
            viewString.Append("            T.CouponIssuedCount AS Coupon_CouponIssuedCount, \r\n            T.Cou");
            viewString.Append("ponRedeemedCount AS Coupon_CouponRedeemedCount, \r\n            T.CouponQtyPerUser");
            viewString.Append(" AS Coupon_CouponQtyPerUser, \r\n            T.CouponListingMode AS Coupon_CouponL");
            viewString.Append("istingMode, \r\n            T.CompanyId AS Coupon_CompanyId, \r\n            T.Coupo");
            viewString.Append("nActiveMonth AS Coupon_CouponActiveMonth, \r\n            T.CouponActiveYear AS Co");
            viewString.Append("upon_CouponActiveYear, \r\n            T.CouponExpirydate AS Coupon_CouponExpiryda");
            viewString.Append("te, \r\n            T.couponImage1 AS Coupon_couponImage1, \r\n            T.CouponI");
            viewString.Append("mage2 AS Coupon_CouponImage2, \r\n            T.CouponImage3 AS Coupon_CouponImage");
            viewString.Append("3, \r\n            T.LogoUrl AS Coupon_LogoUrl, \r\n            T.HighlightLine1 AS ");
            viewString.Append("Coupon_HighlightLine1, \r\n            T.HighlightLine2 AS Coupon_HighlightLine2, ");
            viewString.Append("\r\n            T.HighlightLine3 AS Coupon_HighlightLine3, \r\n            T.Highlig");
            viewString.Append("htLine4 AS Coupon_HighlightLine4, \r\n            T.HighlightLine5 AS Coupon_Highl");
            viewString.Append("ightLine5, \r\n            T.FinePrintLine1 AS Coupon_FinePrintLine1, \r\n          ");
            viewString.Append("  T.FinePrintLine2 AS Coupon_FinePrintLine2, \r\n            T.FinePrintLine3 AS C");
            viewString.Append("oupon_FinePrintLine3, \r\n            T.FinePrintLine4 AS Coupon_FinePrintLine4, \r");
            viewString.Append("\n            T.FinePrintLine5 AS Coupon_FinePrintLine5, \r\n            T.Location");
            viewString.Append("BranchId AS Coupon_LocationBranchId, \r\n            T.LocationTitle AS Coupon_Loc");
            viewString.Append("ationTitle, \r\n            T.LocationLine1 AS Coupon_LocationLine1, \r\n           ");
            viewString.Append(" T.LocationLine2 AS Coupon_LocationLine2, \r\n            T.LocationCity AS Coupon");
            viewString.Append("_LocationCity, \r\n            T.LocationState AS Coupon_LocationState, \r\n        ");
            viewString.Append("    T.LocationZipCode AS Coupon_LocationZipCode, \r\n            T.LocationLAT AS ");
            viewString.Append("Coupon_LocationLAT, \r\n            T.LocationLON AS Coupon_LocationLON, \r\n       ");
            viewString.Append("     T.LocationPhone AS Coupon_LocationPhone, \r\n            T.GeographyColumn AS");
            viewString.Append(" Coupon_GeographyColumn, \r\n            T.HowToRedeemLine1 AS Coupon_HowToRedeemL");
            viewString.Append("ine1, \r\n            T.HowToRedeemLine2 AS Coupon_HowToRedeemLine2, \r\n           ");
            viewString.Append(" T.HowToRedeemLine3 AS Coupon_HowToRedeemLine3, \r\n            T.HowToRedeemLine4");
            viewString.Append(" AS Coupon_HowToRedeemLine4, \r\n            T.HowToRedeemLine5 AS Coupon_HowToRed");
            viewString.Append("eemLine5, \r\n            T.SubmissionDateTime AS Coupon_SubmissionDateTime, \r\n   ");
            viewString.Append("         T.LocationCountryId AS Coupon_LocationCountryId, \r\n            T.Coupon");
            viewString.Append("StartDate AS Coupon_CouponStartDate, \r\n            T.CouponEndDate AS Coupon_Cou");
            viewString.Append("ponEndDate, \r\n            T.Priority AS Coupon_Priority, \r\n            T.ShowBuy");
            viewString.Append("itBtn AS Coupon_ShowBuyitBtn, \r\n            T.BuyitLandingPageUrl AS Coupon_Buyi");
            viewString.Append("tLandingPageUrl, \r\n            T.BuyitBtnLabel AS Coupon_BuyitBtnLabel, \r\n      ");
            viewString.Append("      T.YoutubeLink AS Coupon_YoutubeLink, \r\n            T.CouponImage4 AS Coupo");
            viewString.Append("n_CouponImage4, \r\n            T.CouponImage5 AS Coupon_CouponImage5, \r\n         ");
            viewString.Append("   T.CouponImage6 AS Coupon_CouponImage6, \r\n            T.IsPaymentCollected AS ");
            viewString.Append("Coupon_IsPaymentCollected, \r\n            T.PaymentDate AS Coupon_PaymentDate, \r\n");
            viewString.Append("            T.IsShowReviews AS Coupon_IsShowReviews, \r\n            T.IsShowAddre");
            viewString.Append("ss AS Coupon_IsShowAddress, \r\n            T.IsShowPhoneNo AS Coupon_IsShowPhoneN");
            viewString.Append("o, \r\n            T.IsShowMap AS Coupon_IsShowMap, \r\n            T.IsShowyouTube ");
            viewString.Append("AS Coupon_IsShowyouTube, \r\n            T.IsShowAboutUs AS Coupon_IsShowAboutUs, ");
            viewString.Append("\r\n            T.IsMarketingStories AS Coupon_IsMarketingStories, \r\n            T");
            viewString.Append(".IsPerSaving3days AS Coupon_IsPerSaving3days, \r\n            T.IsPerSaving2days A");
            viewString.Append("S Coupon_IsPerSaving2days, \r\n            T.IsPerSavingLastday AS Coupon_IsPerSav");
            viewString.Append("ingLastday, \r\n            T.IsDollarSaving3days AS Coupon_IsDollarSaving3days, \r");
            viewString.Append("\n            T.IsDollarSaving2days AS Coupon_IsDollarSaving2days, \r\n            ");
            viewString.Append("T.IsDollarSavingLastday AS Coupon_IsDollarSavingLastday, \r\n            T.isSaveB");
            viewString.Append("tnLable AS Coupon_isSaveBtnLable, \r\n            T.DealFirstDiscountType AS Coupo");
            viewString.Append("n_DealFirstDiscountType, \r\n            T.DealEndingDiscountType AS Coupon_DealEn");
            viewString.Append("dingDiscountType, \r\n            T.CashBackDeal AS Coupon_CashBackDeal, \r\n       ");
            viewString.Append("     T.PinCode AS Coupon_PinCode, \r\n            T.CashBackDealCounter AS Coupon_");
            viewString.Append("CashBackDealCounter, \r\n            T.IsAppliedDec AS Coupon_IsAppliedDec, \r\n    ");
    ...
    FROM (
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(2423);
            ...
            viewString.Append("yCode], T1.[vw_Notifications.CurrencySymbol], T1.[vw_Notifications.CouponThumbna");
            viewString.Append("il])\r\n    FROM (\r\n        SELECT \r\n            T.ID AS [vw_Notifications.ID], \r\n");
            viewString.Append("            T.Type AS [vw_Notifications.Type], \r\n            T.UserID AS [vw_Not");
            viewString.Append("ifications.UserID], \r\n            T.IsRead AS [vw_Notifications.IsRead], \r\n     ");
            viewString.Append("       T.GeneratedOn AS [vw_Notifications.GeneratedOn], \r\n            T.Generate");
            viewString.Append("dBy AS [vw_Notifications.GeneratedBy], \r\n            T.SurveyQuestionShareId AS ");
            viewString.Append("[vw_Notifications.SurveyQuestionShareId], \r\n            T.PhoneNumber AS [vw_Not");
            viewString.Append("ifications.PhoneNumber], \r\n            T.NotificationDetails AS [vw_Notification");
            viewString.Append("s.NotificationDetails], \r\n            T.PollTitle AS [vw_Notifications.PollTitle");
            viewString.Append("], \r\n            T.SSQID AS [vw_Notifications.SSQID], \r\n            T.CouponId A");
            viewString.Append("S [vw_Notifications.CouponId], \r\n            T.DealTitle AS [vw_Notifications.De");
            viewString.Append("alTitle], \r\n            T.DealPrice AS [vw_Notifications.DealPrice], \r\n         ");
            viewString.Append("   T.DealSavings AS [vw_Notifications.DealSavings], \r\n            T.DealCount AS");
            viewString.Append(" [vw_Notifications.DealCount], \r\n            T.DealDescription AS [vw_Notificati");
            viewString.Append("ons.DealDescription], \r\n            T.DealCompany AS [vw_Notifications.DealCompa");
            viewString.Append("ny], \r\n            T.DealCity AS [vw_Notifications.DealCity], \r\n            T.Pr");
            viewString.Append("ofileImage AS [vw_Notifications.ProfileImage], \r\n            T.CurrencyCode AS [");
            viewString.Append("vw_Notifications.CurrencyCode], \r\n            T.CurrencySymbol AS [vw_Notificati");
            viewString.Append("ons.CurrencySymbol], \r\n            T.CouponThumbnail AS [vw_Notifications.Coupon");
            viewString.Append("Thumbnail], \r\n            True AS _from0\r\n        FROM BaseDbContext.vw_Notifica");
        ...
        private System.Collections.Generic.KeyValuePair<string, string> GetView139()
        {
            ...
            viewString.Append("ode], T1.[vw_Notifications.CurrencySymbol], T1.[vw_Notifications.CouponThumbnail");
            viewString.Append("])\r\n    FROM (\r\n        SELECT \r\n            T.ID AS [vw_Notifications.ID], \r\n  ");
            viewString.Append("          T.Type AS [vw_Notifications.Type], \r\n            T.UserID AS [vw_Notif");
            viewString.Append("ications.UserID], \r\n            T.IsRead AS [vw_Notifications.IsRead], \r\n       ");
            viewString.Append("     T.GeneratedOn AS [vw_Notifications.GeneratedOn], \r\n            T.GeneratedB");
            viewString.Append("y AS [vw_Notifications.GeneratedBy], \r\n            T.SurveyQuestionShareId AS [v");
            viewString.Append("w_Notifications.SurveyQuestionShareId], \r\n            T.PhoneNumber AS [vw_Notif");
            viewString.Append("ications.PhoneNumber], \r\n            T.NotificationDetails AS [vw_Notifications.");
            viewString.Append("NotificationDetails], \r\n            T.PollTitle AS [vw_Notifications.PollTitle],");
            viewString.Append(" \r\n            T.SSQID AS [vw_Notifications.SSQID], \r\n            T.CouponId AS ");
            viewString.Append("[vw_Notifications.CouponId], \r\n            T.DealTitle AS [vw_Notifications.Deal");
            viewString.Append("Title], \r\n            T.DealPrice AS [vw_Notifications.DealPrice], \r\n           ");
            viewString.Append(" T.DealSavings AS [vw_Notifications.DealSavings], \r\n            T.DealCount AS [");
            viewString.Append("vw_Notifications.DealCount], \r\n            T.DealDescription AS [vw_Notification");
            viewString.Append("s.DealDescription], \r\n            T.DealCompany AS [vw_Notifications.DealCompany");
            viewString.Append("], \r\n            T.DealCity AS [vw_Notifications.DealCity], \r\n            T.Prof");
            viewString.Append("ileImage AS [vw_Notifications.ProfileImage], \r\n            T.CurrencyCode AS [vw");
            viewString.Append("_Notifications.CurrencyCode], \r\n            T.CurrencySymbol AS [vw_Notification");
            viewString.Append("s.CurrencySymbol], \r\n            T.CouponThumbnail AS [vw_Notifications.CouponTh");
            viewString.Append("umbnail], \r\n            True AS _from0\r\n        FROM SMDModelStoreContainer.vw_N");
            viewString.Append("otifications AS T\r\n    ) AS T1");
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(9154);
            ...
            viewString.Append("1.[vw_Coupons.DealEndingDiscountType], T1.[vw_Coupons.CashBackDeal], T1.[vw_Coup");
            viewString.Append("ons.PinCode], T1.[vw_Coupons.CashBackDealCounter], T1.[vw_Coupons.Categories], T");
            viewString.Append("1.[vw_Coupons.CurrencyCode], T1.[vw_Coupons.CurrencySymbol])\r\n    FROM (\r\n      ");
            viewString.Append("  SELECT \r\n            T.CouponId AS [vw_Coupons.CouponId], \r\n            T.Lang");
            viewString.Append("uageId AS [vw_Coupons.LanguageId], \r\n            T.UserId AS [vw_Coupons.UserId]");
            viewString.Append(", \r\n            T.CouponTitle AS [vw_Coupons.CouponTitle], \r\n            T.Searc");
            viewString.Append("hKeywords AS [vw_Coupons.SearchKeywords], \r\n            T.Status AS [vw_Coupons.");
            viewString.Append("Status], \r\n            T.Archived AS [vw_Coupons.Archived], \r\n            T.Appr");
            viewString.Append("oved AS [vw_Coupons.Approved], \r\n            T.ApprovedBy AS [vw_Coupons.Approve");
            viewString.Append("dBy], \r\n            T.ApprovalDateTime AS [vw_Coupons.ApprovalDateTime], \r\n     ");
            viewString.Append("       T.CreatedDateTime AS [vw_Coupons.CreatedDateTime], \r\n            T.Create");
            viewString.Append("dBy AS [vw_Coupons.CreatedBy], \r\n            T.ModifiedDateTime AS [vw_Coupons.M");
            viewString.Append("odifiedDateTime], \r\n            T.ModifiedBy AS [vw_Coupons.ModifiedBy], \r\n     ");
            viewString.Append("       T.RejectedReason AS [vw_Coupons.RejectedReason], \r\n            T.Rejected");
            viewString.Append("datetime AS [vw_Coupons.Rejecteddatetime], \r\n            T.RejectedBy AS [vw_Cou");
            viewString.Append("pons.RejectedBy], \r\n            T.CurrencyId AS [vw_Coupons.CurrencyId], \r\n     ");
            viewString.Append("       T.Price AS [vw_Coupons.Price], \r\n            T.Savings AS [vw_Coupons.Sav");
            viewString.Append("ings], \r\n            T.SwapCost AS [vw_Coupons.SwapCost], \r\n            T.Coupon");
            viewString.Append("ViewCount AS [vw_Coupons.CouponViewCount], \r\n            T.CouponIssuedCount AS ");
            viewString.Append("[vw_Coupons.CouponIssuedCount], \r\n            T.CouponRedeemedCount AS [vw_Coupo");
            viewString.Append("ns.CouponRedeemedCount], \r\n            T.CouponQtyPerUser AS [vw_Coupons.CouponQ");
            viewString.Append("tyPerUser], \r\n            T.CouponListingMode AS [vw_Coupons.CouponListingMode],");
            viewString.Append(" \r\n            T.CompanyId AS [vw_Coupons.CompanyId], \r\n            T.CouponActi");
            viewString.Append("veMonth AS [vw_Coupons.CouponActiveMonth], \r\n            T.CouponActiveYear AS [");
            viewString.Append("vw_Coupons.CouponActiveYear], \r\n            T.CouponExpirydate AS [vw_Coupons.Co");
            viewString.Append("uponExpirydate], \r\n            T.couponImage1 AS [vw_Coupons.couponImage1], \r\n  ");
            viewString.Append("          T.CouponImage2 AS [vw_Coupons.CouponImage2], \r\n            T.CouponIma");
            viewString.Append("ge3 AS [vw_Coupons.CouponImage3], \r\n            T.LogoUrl AS [vw_Coupons.LogoUrl");
            viewString.Append("], \r\n            T.HighlightLine1 AS [vw_Coupons.HighlightLine1], \r\n            ");
            viewString.Append("T.HighlightLine2 AS [vw_Coupons.HighlightLine2], \r\n            T.HighlightLine3 ");
            viewString.Append("AS [vw_Coupons.HighlightLine3], \r\n            T.HighlightLine4 AS [vw_Coupons.Hi");
            viewString.Append("ghlightLine4], \r\n            T.HighlightLine5 AS [vw_Coupons.HighlightLine5], \r\n");
            viewString.Append("            T.FinePrintLine1 AS [vw_Coupons.FinePrintLine1], \r\n            T.Fin");
            viewString.Append("ePrintLine2 AS [vw_Coupons.FinePrintLine2], \r\n            T.FinePrintLine3 AS [v");
            viewString.Append("w_Coupons.FinePrintLine3], \r\n            T.FinePrintLine4 AS [vw_Coupons.FinePri");
            viewString.Append("ntLine4], \r\n            T.FinePrintLine5 AS [vw_Coupons.FinePrintLine5], \r\n     ");
            viewString.Append("       T.LocationBranchId AS [vw_Coupons.LocationBranchId], \r\n            T.Loca");
            viewString.Append("tionTitle AS [vw_Coupons.LocationTitle], \r\n            T.LocationLine1 AS [vw_Co");
            viewString.Append("upons.LocationLine1], \r\n            T.LocationLine2 AS [vw_Coupons.LocationLine2");
            viewString.Append("], \r\n            T.LocationCity AS [vw_Coupons.LocationCity], \r\n            T.Lo");
            viewString.Append("cationState AS [vw_Coupons.LocationState], \r\n            T.LocationZipCode AS [v");
            viewString.Append("w_Coupons.LocationZipCode], \r\n            T.LocationLAT AS [vw_Coupons.LocationL");
            viewString.Append("AT], \r\n            T.LocationLON AS [vw_Coupons.LocationLON], \r\n            T.Lo");
            viewString.Append("cationPhone AS [vw_Coupons.LocationPhone], \r\n            T.GeographyColumn AS [v");
            viewString.Append("w_Coupons.GeographyColumn], \r\n            T.HowToRedeemLine1 AS [vw_Coupons.HowT");
            viewString.Append("oRedeemLine1], \r\n            T.HowToRedeemLine2 AS [vw_Coupons.HowToRedeemLine2]");
            viewString.Append(", \r\n            T.HowToRedeemLine3 AS [vw_Coupons.HowToRedeemLine3], \r\n         ");
            viewString.Append("   T.HowToRedeemLine4 AS [vw_Coupons.HowToRedeemLine4], \r\n            T.HowToRed");
            viewString.Append("eemLine5 AS [vw_Coupons.HowToRedeemLine5], \r\n            T.SubmissionDateTime AS");
            viewString.Append(" [vw_Coupons.SubmissionDateTime], \r\n            T.LocationCountryId AS [vw_Coupo");
            viewString.Append("ns.LocationCountryId], \r\n            T.CouponStartDate AS [vw_Coupons.CouponStar");
            viewString.Append("tDate], \r\n            T.CouponEndDate AS [vw_Coupons.CouponEndDate], \r\n         ");
            viewString.Append("   T.Priority AS [vw_Coupons.Priority], \r\n            T.ShowBuyitBtn AS [vw_Coup");
            viewString.Append("ons.ShowBuyitBtn], \r\n            T.BuyitLandingPageUrl AS [vw_Coupons.BuyitLandi");
            viewString.Append("ngPageUrl], \r\n            T.BuyitBtnLabel AS [vw_Coupons.BuyitBtnLabel], \r\n     ");
            viewString.Append("       T.YoutubeLink AS [vw_Coupons.YoutubeLink], \r\n            T.CouponImage4 A");
            viewString.Append("S [vw_Coupons.CouponImage4], \r\n            T.CouponImage5 AS [vw_Coupons.CouponI");
            viewString.Append("mage5], \r\n            T.CouponImage6 AS [vw_Coupons.CouponImage6], \r\n           ");
            viewString.Append(" T.IsPaymentCollected AS [vw_Coupons.IsPaymentCollected], \r\n            T.Paymen");
            viewString.Append("tDate AS [vw_Coupons.PaymentDate], \r\n            T.IsShowReviews AS [vw_Coupons.");
            viewString.Append("IsShowReviews], \r\n            T.IsShowAddress AS [vw_Coupons.IsShowAddress], \r\n ");
            viewString.Append("           T.IsShowPhoneNo AS [vw_Coupons.IsShowPhoneNo], \r\n            T.IsShow");
            viewString.Append("Map AS [vw_Coupons.IsShowMap], \r\n            T.IsShowyouTube AS [vw_Coupons.IsSh");
            viewString.Append("owyouTube], \r\n            T.IsShowAboutUs AS [vw_Coupons.IsShowAboutUs], \r\n     ");
            viewString.Append("       T.IsMarketingStories AS [vw_Coupons.IsMarketingStories], \r\n            T.");
            viewString.Append("IsPerSaving3days AS [vw_Coupons.IsPerSaving3days], \r\n            T.IsPerSaving2d");
            viewString.Append("ays AS [vw_Coupons.IsPerSaving2days], \r\n            T.IsPerSavingLastday AS [vw_");
            viewString.Append("Coupons.IsPerSavingLastday], \r\n            T.IsDollarSaving3days AS [vw_Coupons.");
            viewString.Append("IsDollarSaving3days], \r\n            T.IsDollarSaving2days AS [vw_Coupons.IsDolla");
            viewString.Append("rSaving2days], \r\n            T.IsDollarSavingLastday AS [vw_Coupons.IsDollarSavi");
            viewString.Append("ngLastday], \r\n            T.isSaveBtnLable AS [vw_Coupons.isSaveBtnLable], \r\n   ");
            ...
            viewString.Append("     T.CashBackDeal AS [vw_Coupons.CashBackDeal], \r\n            T.PinCode AS [vw");
            viewString.Append("_Coupons.PinCode], \r\n            T.CashBackDealCounter AS [vw_Coupons.CashBackDe");
            viewString.Append("alCounter], \r\n            T.Categories AS [vw_Coupons.Categories], \r\n           ");
            viewString.Append(" T.CurrencyCode AS [vw_Coupons.CurrencyCode], \r\n            T.CurrencySymbol AS ");
            viewString.Append("[vw_Coupons.CurrencySymbol], \r\n            True AS _from0\r\n        FROM BaseDbCo");
            viewString.Append("ntext.vw_Coupons AS T\r\n    ) AS T1");
        ...
        {
            System.Text.StringBuilder viewString = new System.Text.StringBuilder(9161);
            ...
            viewString.Append("vw_Coupons.BuyitBtnLabel], T1.[vw_Coupons.YoutubeLink], T1.[vw_Coupons.CouponIma");
            viewString.Append("ge4], T1.[vw_Coupons.CouponImage5], T1.[vw_Coupons.CouponImage6], T1.[vw_Coupons");
            viewString.Append(".IsPaymentCollected], T1.[vw_Coupons.PaymentDate], T1.[vw_Coupons.IsShowReviews]");
            viewString.Append(", T1.[vw_Coupons.IsShowAddress], T1.[vw_Coupons.IsShowPhoneNo], T1.[vw_Coupons.I");
            viewString.Append("sShowMap], T1.[vw_Coupons.IsShowyouTube], T1.[vw_Coupons.IsShowAboutUs], T1.[vw_");
            viewString.Append("Coupons.IsMarketingStories], T1.[vw_Coupons.IsPerSaving3days], T1.[vw_Coupons.Is");
            viewString.Append("PerSaving2days], T1.[vw_Coupons.IsPerSavingLastday], T1.[vw_Coupons.IsDollarSavi");
            viewString.Append("ng3days], T1.[vw_Coupons.IsDollarSaving2days], T1.[vw_Coupons.IsDollarSavingLast");
            viewString.Append("day], T1.[vw_Coupons.isSaveBtnLable], T1.[vw_Coupons.DealFirstDiscountType], T1.");
            viewString.Append("[vw_Coupons.DealEndingDiscountType], T1.[vw_Coupons.CashBackDeal], T1.[vw_Coupon");
            viewString.Append("s.PinCode], T1.[vw_Coupons.CashBackDealCounter], T1.[vw_Coupons.Categories], T1.");
            viewString.Append("[vw_Coupons.CurrencyCode], T1.[vw_Coupons.CurrencySymbol])\r\n    FROM (\r\n        ");
            viewString.Append("SELECT \r\n            T.CouponId AS [vw_Coupons.CouponId], \r\n            T.Langua");
            viewString.Append("geId AS [vw_Coupons.LanguageId], \r\n            T.UserId AS [vw_Coupons.UserId], ");
            viewString.Append("\r\n            T.CouponTitle AS [vw_Coupons.CouponTitle], \r\n            T.SearchK");
            viewString.Append("eywords AS [vw_Coupons.SearchKeywords], \r\n            T.Status AS [vw_Coupons.St");
            viewString.Append("atus], \r\n            T.Archived AS [vw_Coupons.Archived], \r\n            T.Approv");
            viewString.Append("ed AS [vw_Coupons.Approved], \r\n            T.ApprovedBy AS [vw_Coupons.ApprovedB");
            viewString.Append("y], \r\n            T.ApprovalDateTime AS [vw_Coupons.ApprovalDateTime], \r\n       ");
            viewString.Append("     T.CreatedDateTime AS [vw_Coupons.CreatedDateTime], \r\n            T.CreatedB");
            viewString.Append("y AS [vw_Coupons.CreatedBy], \r\n            T.ModifiedDateTime AS [vw_Coupons.Mod");
            viewString.Append("ifiedDateTime], \r\n            T.ModifiedBy AS [vw_Coupons.ModifiedBy], \r\n       ");
            viewString.Append("     T.RejectedReason AS [vw_Coupons.RejectedReason], \r\n            T.Rejectedda");
            viewString.Append("tetime AS [vw_Coupons.Rejecteddatetime], \r\n            T.RejectedBy AS [vw_Coupo");
            viewString.Append("ns.RejectedBy], \r\n            T.CurrencyId AS [vw_Coupons.CurrencyId], \r\n       ");
            viewString.Append("     T.Price AS [vw_Coupons.Price], \r\n            T.Savings AS [vw_Coupons.Savin");
            viewString.Append("gs], \r\n            T.SwapCost AS [vw_Coupons.SwapCost], \r\n            T.CouponVi");
            viewString.Append("ewCount AS [vw_Coupons.CouponViewCount], \r\n            T.CouponIssuedCount AS [v");
            viewString.Append("w_Coupons.CouponIssuedCount], \r\n            T.CouponRedeemedCount AS [vw_Coupons");
            viewString.Append(".CouponRedeemedCount], \r\n            T.CouponQtyPerUser AS [vw_Coupons.CouponQty");
            viewString.Append("PerUser], \r\n            T.CouponListingMode AS [vw_Coupons.CouponListingMode], \r");
            viewString.Append("\n            T.CompanyId AS [vw_Coupons.CompanyId], \r\n            T.CouponActive");
            viewString.Append("Month AS [vw_Coupons.CouponActiveMonth], \r\n            T.CouponActiveYear AS [vw");
            viewString.Append("_Coupons.CouponActiveYear], \r\n            T.CouponExpirydate AS [vw_Coupons.Coup");
            viewString.Append("onExpirydate], \r\n            T.couponImage1 AS [vw_Coupons.couponImage1], \r\n    ");
            viewString.Append("        T.CouponImage2 AS [vw_Coupons.CouponImage2], \r\n            T.CouponImage");
            viewString.Append("3 AS [vw_Coupons.CouponImage3], \r\n            T.LogoUrl AS [vw_Coupons.LogoUrl],");
            viewString.Append(" \r\n            T.HighlightLine1 AS [vw_Coupons.HighlightLine1], \r\n            T.");
            viewString.Append("HighlightLine2 AS [vw_Coupons.HighlightLine2], \r\n            T.HighlightLine3 AS");
            viewString.Append(" [vw_Coupons.HighlightLine3], \r\n            T.HighlightLine4 AS [vw_Coupons.High");
            viewString.Append("lightLine4], \r\n            T.HighlightLine5 AS [vw_Coupons.HighlightLine5], \r\n  ");
            viewString.Append("          T.FinePrintLine1 AS [vw_Coupons.FinePrintLine1], \r\n            T.FineP");
            viewString.Append("rintLine2 AS [vw_Coupons.FinePrintLine2], \r\n            T.FinePrintLine3 AS [vw_");
            viewString.Append("Coupons.FinePrintLine3], \r\n            T.FinePrintLine4 AS [vw_Coupons.FinePrint");
            viewString.Append("Line4], \r\n            T.FinePrintLine5 AS [vw_Coupons.FinePrintLine5], \r\n       ");
            viewString.Append("     T.LocationBranchId AS [vw_Coupons.LocationBranchId], \r\n            T.Locati");
            viewString.Append("onTitle AS [vw_Coupons.LocationTitle], \r\n            T.LocationLine1 AS [vw_Coup");
            viewString.Append("ons.LocationLine1], \r\n            T.LocationLine2 AS [vw_Coupons.LocationLine2],");
            viewString.Append(" \r\n            T.LocationCity AS [vw_Coupons.LocationCity], \r\n            T.Loca");
            viewString.Append("tionState AS [vw_Coupons.LocationState], \r\n            T.LocationZipCode AS [vw_");
            viewString.Append("Coupons.LocationZipCode], \r\n            T.LocationLAT AS [vw_Coupons.LocationLAT");
            viewString.Append("], \r\n            T.LocationLON AS [vw_Coupons.LocationLON], \r\n            T.Loca");
            viewString.Append("tionPhone AS [vw_Coupons.LocationPhone], \r\n            T.GeographyColumn AS [vw_");
            viewString.Append("Coupons.GeographyColumn], \r\n            T.HowToRedeemLine1 AS [vw_Coupons.HowToR");
            viewString.Append("edeemLine1], \r\n            T.HowToRedeemLine2 AS [vw_Coupons.HowToRedeemLine2], ");
            viewString.Append("\r\n            T.HowToRedeemLine3 AS [vw_Coupons.HowToRedeemLine3], \r\n           ");
            viewString.Append(" T.HowToRedeemLine4 AS [vw_Coupons.HowToRedeemLine4], \r\n            T.HowToRedee");
            viewString.Append("mLine5 AS [vw_Coupons.HowToRedeemLine5], \r\n            T.SubmissionDateTime AS [");
            viewString.Append("vw_Coupons.SubmissionDateTime], \r\n            T.LocationCountryId AS [vw_Coupons");
            viewString.Append(".LocationCountryId], \r\n            T.CouponStartDate AS [vw_Coupons.CouponStartD");
            viewString.Append("ate], \r\n            T.CouponEndDate AS [vw_Coupons.CouponEndDate], \r\n           ");
            viewString.Append(" T.Priority AS [vw_Coupons.Priority], \r\n            T.ShowBuyitBtn AS [vw_Coupon");
            viewString.Append("s.ShowBuyitBtn], \r\n            T.BuyitLandingPageUrl AS [vw_Coupons.BuyitLanding");
            viewString.Append("PageUrl], \r\n            T.BuyitBtnLabel AS [vw_Coupons.BuyitBtnLabel], \r\n       ");
            viewString.Append("     T.YoutubeLink AS [vw_Coupons.YoutubeLink], \r\n            T.CouponImage4 AS ");
            viewString.Append("[vw_Coupons.CouponImage4], \r\n            T.CouponImage5 AS [vw_Coupons.CouponIma");
            viewString.Append("ge5], \r\n            T.CouponImage6 AS [vw_Coupons.CouponImage6], \r\n            T");
            viewString.Append(".IsPaymentCollected AS [vw_Coupons.IsPaymentCollected], \r\n            T.PaymentD");
            viewString.Append("ate AS [vw_Coupons.PaymentDate], \r\n            T.IsShowReviews AS [vw_Coupons.Is");
            viewString.Append("ShowReviews], \r\n            T.IsShowAddress AS [vw_Coupons.IsShowAddress], \r\n   ");
            viewString.Append("         T.IsShowPhoneNo AS [vw_Coupons.IsShowPhoneNo], \r\n            T.IsShowMa");
            viewString.Append("p AS [vw_Coupons.IsShowMap], \r\n            T.IsShowyouTube AS [vw_Coupons.IsShow");
            viewString.Append("youTube], \r\n            T.IsShowAboutUs AS [vw_Coupons.IsShowAboutUs], \r\n       ");
            viewString.Append("     T.IsMarketingStories AS [vw_Coupons.IsMarketingStories], \r\n            T.Is");
            viewString.Append("PerSaving3days AS [vw_Coupons.IsPerSaving3days], \r\n            T.IsPerSaving2day");
            viewString.Append("s AS [vw_Coupons.IsPerSaving2days], \r\n            T.IsPerSavingLastday AS [vw_Co");
            viewString.Append("upons.IsPerSavingLastday], \r\n            T.IsDollarSaving3days AS [vw_Coupons.Is");
            viewString.Append("DollarSaving3days], \r\n            T.IsDollarSaving2days AS [vw_Coupons.IsDollarS");
            viewString.Append("aving2days], \r\n            T.IsDollarSavingLastday AS [vw_Coupons.IsDollarSaving");
            viewString.Append("Lastday], \r\n            T.isSaveBtnLable AS [vw_Coupons.isSaveBtnLable], \r\n     ");
            viewString.Append("       T.DealFirstDiscountType AS [vw_Coupons.DealFirstDiscountType], \r\n        ");
            viewString.Append("    T.DealEndingDiscountType AS [vw_Coupons.DealEndingDiscountType], \r\n         ");
            viewString.Append("   T.CashBackDeal AS [vw_Coupons.CashBackDeal], \r\n            T.PinCode AS [vw_C");
            viewString.Append("oupons.PinCode], \r\n            T.CashBackDealCounter AS [vw_Coupons.CashBackDeal");
            viewString.Append("Counter], \r\n            T.Categories AS [vw_Coupons.Categories], \r\n            T");
            viewString.Append(".CurrencyCode AS [vw_Coupons.CurrencyCode], \r\n            T.CurrencySymbol AS [v");
            viewString.Append("w_Coupons.CurrencySymbol], \r\n            True AS _from0\r\n        FROM SMDModelSt");
            viewString.Append("oreContainer.vw_Coupons AS T\r\n    ) AS T1");
