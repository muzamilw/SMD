USE [SMDv2]
GO
/****** Object:  StoredProcedure [dbo].[getCampaignROItblAnalytic]    Script Date: 1/22/2017 7:37:00 PM ******/
SET ANSI_NULLS ON
GO
...
DECLARE @dateFrom DATE = getdate()-30, @openAds float = 1;
	...
	END
		...
		where t.AdCampaignID = @Id and a.CompanyId != (select TOP 1 companyid from aspnetusers where email = 'cash4ads@cash4ads.com')	
		union
...
--EXEC [getCampaignROItblAnalytic] 20369
