define(["ko", "underscore", "underscore-ko"], function (ko) {
	...
	var // ReSharper disable InconsistentNaming
      Coupons = function (sQId, spcName, spcDes, spcIsApproved, spcRejectionReason,
	...
	var CouponsServertoClientMapper = function (itemFromServer) {
		...
		return new Coupons(itemFromServer.CampaignId, itemFromServer.CampaignName, itemFromServer.Description,
