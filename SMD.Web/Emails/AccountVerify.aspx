...
<head>
    ...
    <title>We're glad you're here, ++firstname++.
    </title>
    <style type="text/css">
        /*////// RESET STYLES //////*/
        p {
                  ...
                  <table align="center" border="0" cellpadding="0" cellspacing="0" class="emailContainer" style="max-width:400px;" width="100%">                    
                    <tr>                      
                      <td align="center" id="logoContainer" style="padding-top:40px; padding-bottom:20px;" valign="top">                        
                        <img alt="MailChimp" height="100" src="http://manage.cash4ads.com/emails/images/Cash4Ads_Email_Logo.png" style="color:#FFFFFF; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; letter-spacing:-1px; padding:0; margin:0; text-align:center;" width="100"/>
                      </td>
                    </tr>
                    <tr>                      
                                  ...
                                  <td align="left" id="bodyContent" valign="top">                                    
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">                                      
                                        ...
                                        <td align="center" style="padding-bottom:40px;text-align:center" valign="top" colspan="2">                                          
                                             ...
                                             <p style="color:#737373; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:24px; font-weight:700; line-height:24px; padding-top:0; margin-top:0; text-align:center;">
                                            We're glad you're here, ++firstname++.
                                          </p>
...
<!--[if gte mso 9]>
                                ...
                                <tr>                                  
                                  <td align="center" style="padding-bottom:60px;" valign="top">                                    
                                    <table align="center" bgcolor="#F2F2F2" border="0" cellpadding="0" cellspacing="0" style="background-color:#fff; border-collapse:separate; border-radius:4px;" width="100%">                                      
                                      <tr>                                        
                                        <td align="center" style="padding:20px;" valign="middle">   
                                            <img src="http://manage.cash4ads.com/emails/images/Deals_Email_Blue.png" style="border:0; display:block; height:auto; max-width:60px; outline:none; text-decoration:none; width:60px; -ms-interpolation-mode: bicubic;" width="60" />                                       
                                        </td>
                                           <td align="center" style="padding:20px;" valign="middle"><img src="http://manage.cash4ads.com/emails/images/Videos_Email_Blue.png" style="border:0; display:block; height:auto; max-width:60px; outline:none; text-decoration:none; width:60px; -ms-interpolation-mode: bicubic;" width="60" />                                       </td>
                                           <td align="center" style="padding:20px;" valign="middle"><img src="http://manage.cash4ads.com/emails/images/Display_Email_Blue.png" style="border:0; display:block; height:auto; max-width:60px; outline:none; text-decoration:none; width:60px; -ms-interpolation-mode: bicubic;" width="60" />                                       </td>
                                           <td align="center" style="padding:20px;" valign="middle"><img src="http://manage.cash4ads.com/emails/images/Polls_Email_Blue.png" style="border:0; display:block; height:auto; max-width:60px; outline:none; text-decoration:none; width:60px; -ms-interpolation-mode: bicubic;" width="60" />                                       </td>
                                      </tr>
                                        <tr>
                                            <td align="center" style="padding:20px;" valign="middle">      
                                                <p style="color:#0f68a1; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:16px; font-weight:700; line-height:24px; padding-top:0; margin-top:0; text-align:center;">
                                            Deals
                                          </p>                                    
                                        </td>
                                           <td align="center" style="padding:20px;" valign="middle"><p style="color:#0f68a1; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:16px; font-weight:700; line-height:24px; padding-top:0; margin-top:0; text-align:center;">Video Ads</p></td>
                                           <td align="center" style="padding:20px;" valign="middle"><p style="color:#0f68a1; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:16px; font-weight:700; line-height:24px; padding-top:0; margin-top:0; text-align:center;">Brain Games</p></td>
                                           <td align="center" style="padding:20px;" valign="middle"><p style="color:#0f68a1; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:16px; font-weight:700; line-height:24px; padding-top:0; margin-top:0; text-align:center;">Surveys</p></td>
