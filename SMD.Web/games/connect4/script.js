...
function Game() {
    ...
    this.drawMask = function () {
        ...
        for (y = 0; y < 6; y++) {
            for (x = 0; x < 7; x++) {
                ...
                this.context.rect(50 * x + 50, 50 * y, -50, 50);
                this.context.arc(50 * x + 25, 50 * y + 25, this.cRadius, 0, 2 * Math.PI);
    ...
    this.draw = function () {
        ...
        for (y = 0; y < 6; y++) {
            for (x = 0; x < 7; x++) {
                ...
                this.drawCircle(50 * x + 25, 50 * y + 25, this.cRadius, fg_color, "black");
            }
        }
    };
    this.clear = function () {
    ...
    this.animate = function (column, move, to_row, cur_pos, callback) {
        ...
        if (to_row * 50 >= cur_pos) {
            this.clear();
            this.draw();
            this.drawCircle(50 * column + 25, cur_pos + 25, this.cRadius, fg_color, "black");
            this.drawMask();
    ...
    this.onclick = function (canvas, e) {
        ...
        var j, valid;
        for (j = 0; j < 7; j++) {
            if (this.onregion([x, y], 50 * j + 25, 25)) {
